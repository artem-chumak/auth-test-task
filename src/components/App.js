...
function App() {
  ...
  const handlePassForgotten = () => {
    isPasswordForgotten ? setPasswordForgotten(false) : setPasswordForgotten(true);
  }
    ...
    <>
      ...
      <main className="main">
        ...
        <div className="signin_box">
          <form onSubmit={handleSubmit} className="signin_form" action="#" name="signin">
            <label className="lable" forhtml="email">Email address</label>
            <input value={data.email} onChange={handleChange} className="input" type="email" name="email" id="email" required />
            <div className="lable_box">
              <label className="lable" forhtml="password">Password</label>
              <span onClick={handlePassForgotten} className="link">Forgot password?</span>
            </div>
            <input value={data.password} onChange={handleChange} className="input" type="password" name="password" id="password" required />
        ...
        <div className={isPasswordSent ? 'greenallert' : 'hide'}>
          ...
          <button onClick={handleCloseAlert} className="greenallert_exit"></button>
        </div>

        <div className={isPasswordForgotten ? "forgot_box" : "hide"}>
          <form onSubmit={handleSubmitNewPass} className="forgot_form" action="#" name="forgot">
